...
dataset from the LSST data challenge (``PT1.1'', \citeds{Document-26217}). We used two tables:
...
without running out of threads, we partitioned the PT1.2 \citedsp{Document-9044} Object table
